...
public class FmlDetalhesRobo extends JDialog {
    ...
    public FmlDetalhesRobo(RoboExplorador robo, int indiceRobo) {
        ...
        UtilTela.configurarDialogo(this, robo.getNome(), 500, 760);
        setModal(true);
        configurarTela();
        carregarDadosRobo();
    }
    ...
    private void initComponents() {
        ...
        pnlPrincipal.setBackground(new java.awt.Color(214, 108, 34));
        ...
        pnlBotoes.setBackground(new java.awt.Color(214, 108, 34));
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(pnlConteudo, javax.swing.GroupLayout.DEFAULT_SIZE, 500, Short.MAX_VALUE)
        );
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(pnlConteudo, javax.swing.GroupLayout.DEFAULT_SIZE, 685, Short.MAX_VALUE)
        );
    ...
    protected void carregarDadosRobo() {
        ...
        lblTitulo.setForeground(new java.awt.Color(255,255,255));
        ImageIcon icone = UtilTela.carregarIcone(robo.getImagem(), 500, 250);
        if (icone != null) {
    ...
    protected void adicionarBlocoTexto(String titulo, String conteudo) {
        ...
        pnlBloco.setBackground(new java.awt.Color(214,108,34));
        ...
        pnlBloco.setMaximumSize(new Dimension(490, 30));
        ...
        lblTituloCampo.setForeground(new java.awt.Color(0,0,0));
        ...
        txtConteudo.setBackground(new java.awt.Color(214,108,34));
        ...
        txtConteudo.setMaximumSize(new Dimension(350, 170));
