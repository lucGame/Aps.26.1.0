...
public class FmlMenuPrincipal extends JDialog {
    ...
    private void initComponents() {
        ...
        pnlTopo.add(lblTitulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 489, 80));
        ...
        pnlTopo.add(lblSubtitulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 86, 489, 80));
        ...
        pnlTopo.add(lblInstrucao, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 172, 489, 80));

        pnlBusca.setBackground(new java.awt.Color(214, 108, 34));

        txtBusca.setBackground(new java.awt.Color(184, 100, 51));
        ...
        pnlBuscaLayout.setHorizontalGroup(
            ...
            .addComponent(btnTeclado, javax.swing.GroupLayout.PREFERRED_SIZE, 489, javax.swing.GroupLayout.PREFERRED_SIZE)
            .addComponent(btnLimparBusca, javax.swing.GroupLayout.PREFERRED_SIZE, 489, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
        pnlBuscaLayout.setVerticalGroup(
            pnlBuscaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(pnlBuscaLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(txtBusca, javax.swing.GroupLayout.PREFERRED_SIZE, 60, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(btnTeclado, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(btnLimparBusca, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );

        pnlTopo.add(pnlBusca, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 256, -1, 140));
        ...
        pnlListaRobos.setBackground(new java.awt.Color(214, 108, 34));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addComponent(pnlConteudo, javax.swing.GroupLayout.PREFERRED_SIZE, 489, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, Short.MAX_VALUE))
        );
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(layout.createSequentialGroup()
                .addComponent(pnlConteudo, javax.swing.GroupLayout.PREFERRED_SIZE, 714, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, Short.MAX_VALUE))
        );
    ...
    protected void atualizarListaRobos(String filtro) {
        ...
        if (quantidadeExibida == 0) {
            ...
            lblSemResultados.setForeground(new Color(0,0,0));
    ...
    private JButton criarBotaoRobo(RoboExplorador robo, int indiceRobo) {
        JButton btnRobo = new JButton("<html><div style='text-align:left;'><b>" + robo.getNome()
                ...
                + "</span><br/><span style='color:#FFFFFF;'>Toque para ver detalhes</span></div></html>");
        btnRobo.setHorizontalAlignment(SwingConstants.LEFT);
        btnRobo.setFocusPainted(false);
        btnRobo.setBackground(new Color(255,255,255));
        btnRobo.setForeground(new Color(0, 0, 0));
        ...
        btnRobo.setContentAreaFilled(false);
        btnRobo.setOpaque(true);
        btnRobo.setBackground(new Color(214,108,34));
        return btnRobo;
    }
