...
public class FmlQuestionario extends JDialog {
    ...
    private void initComponents() {
        ...
        lblPergunta.setBackground(new java.awt.Color(214, 108, 34));
        ...
        lblPergunta.setText("Pergunta exibida aqui");
        lblPergunta.setWrapStyleWord(true);
        pnlCentro.add(lblPergunta, java.awt.BorderLayout.NORTH);

        pnlOpcoes.setBackground(new java.awt.Color(214, 108, 34));
        pnlOpcoes.setLayout(new java.awt.GridLayout(4, 1, 0, 8));

        rdbOpcao1.setBackground(new java.awt.Color(214, 108, 34));
        rdbOpcao1.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        rdbOpcao1.setForeground(new java.awt.Color(255, 255, 255));
        rdbOpcao1.setText("Opcao 1");
        pnlOpcoes.add(rdbOpcao1);

        rdbOpcao2.setBackground(new java.awt.Color(214, 108, 34));
        rdbOpcao2.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        rdbOpcao2.setForeground(new java.awt.Color(255, 255, 255));
        rdbOpcao2.setText("Opcao 2");
        pnlOpcoes.add(rdbOpcao2);

        rdbOpcao3.setBackground(new java.awt.Color(214, 108, 34));
        rdbOpcao3.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        rdbOpcao3.setForeground(new java.awt.Color(255, 255, 255));
        rdbOpcao3.setText("Opcao 3");
        pnlOpcoes.add(rdbOpcao3);

        rdbOpcao4.setBackground(new java.awt.Color(214, 108, 34));
        rdbOpcao4.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        rdbOpcao4.setForeground(new java.awt.Color(255, 255, 255));
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(pnlConteudo, javax.swing.GroupLayout.DEFAULT_SIZE, 793, Short.MAX_VALUE)
        );
