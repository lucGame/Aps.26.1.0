...
public class CatalogoRobos {
    ...
    protected static void carregarRobos() {
        ...
        listaRobos.add(new RoboExplorador(
                ...
                "Viking 1",
                "/imagens/viking1.png",
                "Lançamento em 20/08/1975 pela missão Viking Program (NASA).",
                "Titan IIIE-Centaur",
                "Cabo Canaveral, Flórida, EUA.",
                "Sim. A espaçonave realizou inserção orbital em Marte antes de liberar o módulo de pouso.",
                "Pouso em 20/07/1976. O local recebeu o nome de Chryse Planitia Landing Site.",
                "Chryse Planitia, Marte.",
                "Viking Lander 1",
                "O Viking 1 foi planejado para durar 90 dias, mas funcionou por mais de 6 anos, até 13/11/1982. Foi a primeira missão a operar com sucesso na superfície de Marte por longo prazo.",
                "O programa Viking (Viking 1 e Viking 2) foi pioneiro: os primeiros pousos bem-sucedidos em Marte. Viking 1 realizou experimentos biológicos para procurar sinais de vida, além de análises químicas e imagens da superfície. Trouxe dados sobre o solo marciano e sua química, revelando a complexidade do ambiente.pois abriu caminho para todas as missões posteriores de exploração em Marte."
        ));
